...
TVS_lat_rings[2] = [tvel_universe, tvel_universe, absorber_tube_universe] * 6
TVS_lat_rings[3] = [tvel_universe, tvel_universe, tvel_universe, tvel_with_Gd_universe] * 6
TVS_lat_rings[4] = [absorber_tube_universe, tvel_universe, tvel_universe, tvel_universe, tvel_universe] * 6
TVS_lat_rings[5] = [tvel_universe, tvel_universe, tvel_universe, absorber_tube_universe, tvel_universe,
                    tvel_universe] * 6
